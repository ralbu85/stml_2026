    ...
    include-in-header:
      text: |
        <style>
          ...
          .reveal .part { color: #1a3a5c; font-weight: 600; letter-spacing: .04em; }
        </style>
---

## Session Overview

[Part 1 · Understanding the agentic paradigm]{.part}
...
[Part 2 · The definition and the autonomy spectrum]{.part}
...
[Part 3 · The four core components]{.part}
...
[Part 4 · Anthropic's five workflow patterns]{.part}
...
[Part 5 · Ng's four design patterns]{.part}
...
[Part 6 · Evidence and the conditions for success]{.part}
