...
> ⚠️ **주차 번호 주의:** 이 문서의 주차 번호는 2026-07-10 이전 구판 기준이며, 2026-07-13 v4 재조정으로 더 이상 직접 대응하지 않는다. 현행 주차는 [`docs/lecture-outlines.md`](lecture-outlines.md)를 기준으로 하고, 이 문서는 자료→주제 매핑 기록으로만 읽는다 (주제 기준: 프롬프팅·추론=W2, 도구=W3, 루프=W4, RAG=W5–6, 계획=W7, 반성=W8).
