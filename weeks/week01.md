...
- **교수 시연 발표:** Self-Consistency (Wang et al., 2022 · [arXiv:2203.11171](https://arxiv.org/abs/2203.11171)) — 6장 템플릿·15분 하드 스톱 그대로 시연. 수업 발표 목록에 없는 논문이라 스포일러가 없고, W2(프롬프팅과 추론) 이론·실습의 예고편이 된다.
