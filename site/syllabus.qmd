...
Each week combines a concept lecture, a hands-on implementation lab (Jupyter notebooks), and individual oral paper presentations. The weekly lab components accumulate into a complete research-assistant agent by the end of the term.
...
The midterm (Week 8) and final (Week 15) are written exams focused on understanding the structure and principles of agent systems. Paper presentations are given individually, and weekly labs (assignments) and class participation are also assessed.
...
| Quizzes | 0% | Not used |
| Other | 20% | Individual oral paper presentations and class participation |
